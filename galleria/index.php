<?php
	...
	// gestione della modifica del database
    ...
    if (isset($_FILES['attachments'])) {
        $msg = "";
        $targetFile = time() . basename($_FILES['attachments']['name'][0]); 	//fa si che caricando lo stesso file due volte, esso abbia nomi diversi
        ...
        if (file_exists($targetFile))
            ...
            $conn->query("INSERT INTO photos (path, uploadedOn) VALUES ('$targetFile', NOW())");	//si crea la corrispondenza della foto nel database
        }
...
<html>
	...
	<!-- carico la navbar alla pagina -->
	<div class="container fixed-top" id="nav-placeholder" style="margin-top: 0px;">
	<script>
	$(function(){
		...
		<div class="container">
            <div class="row">
                ...
                <img src="../immagini/logo.svg"><br><br>
                <div id="dropZone">
        ...
        <script type="text/javascript">
			...
			<!-- se carico più immagini del consentito si blocca -->
